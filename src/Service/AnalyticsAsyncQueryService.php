...
use App\Analysing\ServiceInterface\AnalyticsAsyncQueryServiceInterface;
use Psr\Log\LoggerInterface;
use Random\RandomException;

final class AnalyticsAsyncQueryService implements AnalyticsAsyncQueryServiceInterface
{
