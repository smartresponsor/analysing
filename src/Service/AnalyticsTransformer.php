...
use App\Analysing\ServiceInterface\AnalyticsTransformerInterface;
use Psr\Log\LoggerInterface;

final class AnalyticsTransformer implements AnalyticsTransformerInterface
{
    ...
    public function map(array $rows, callable $fn): array
    {
        if (count($rows) > self::MAX_ROWS) {
            ...
            throw new \InvalidArgumentException('AnalyticsTransformer rows exceed the maximum allowed size.');
        }
