...
use App\Analysing\ServiceInterface\AnalyticsDashboardHtmlRendererInterface;
use App\Analysing\ServiceInterface\Http\AnalyticsVendorContextInterface;

final readonly class AnalyticsDashboardHtmlRenderer implements AnalyticsDashboardHtmlRendererInterface
{
    public function __construct(
        private AnalyticsRequestCorrelationIdProviderInterface $correlationIds,
        private AnalyticsVendorContextInterface $vendorContext,
    ) {
    }
    ...
    public function renderError(string $title, string $message, int $status): string
    {
        ...
        return implode("\n", [
            ...
            '      <li>Vendor: <strong>'.$this->escape($vendor).'</strong></li>',
