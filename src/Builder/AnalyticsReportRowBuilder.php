...
namespace App\Analysing\Builder;
 ...
 */
final class AnalyticsReportRowBuilder implements AnalyticsReportRowBuilderInterface
{
    /**
     * Builds an array of rows for the report based on KPI and timeseries data.
     *
     * @param AnalyticsKpiRequestDTO                                                        $request the KPI request containing the filters and options for the report
