...
use App\Analysing\Factory\AnalyticsDashboardRequestFactory;
...
final class AnalyticsDashboardPageController implements AnalyticsDashboardPageControllerInterface
{
    private const string COMPONENT = 'analytics';
    private const string OPERATION = 'dashboard_page';

    public function __construct(
        private readonly AnalyticsDashboardServiceInterface $svc,
        private readonly LoggerInterface $logger,
        private readonly AnalyticsDashboardHtmlRenderer $htmlRenderer,
        ...
        private readonly ?AnalyticsDashboardRequestFactory $requestFactory = null,
    ) {
    }
    ...
    public function index(Request $req): Response
    {
        ...
        try {
            $dto = ($this->requestFactory ?? new AnalyticsDashboardRequestFactory())->fromRequest($req);
