...
final class AnalyticsIngestController implements AnalyticsIngestControllerInterface
{
    ...
    public function __construct(
        private readonly AnalyticsClickhouseClientInterface $client,
    ...
    private function ingestCommon(string $source, Request $request): array
    {
        ...
        $vendor = $this->normalizeIdentifier($request->headers->get('X-SR-VENDOR') ?? 'unknown', 'vendor header');
