...
final class SampleAnalyticsRepositoryTest extends TestCase
{
    public function testFetchFunnelReturnsSampleRows(): void
    {
        $repository = new AnalyticsSampleAnalyticsRepository(new AnalyticsSampleAnalyticsDataset(), new NullLogger());
